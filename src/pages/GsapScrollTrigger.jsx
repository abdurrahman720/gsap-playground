...
const GsapScrollTrigger = () => {
  //decalre a ref to attach it with the targets (here the boxes)
    ...
    () => {
      ...
      boxes.forEach((box) => {
        gsap.to(box, {
          ...
          scrollTrigger: {
            trigger: box,
            start: "bottom bottom", //when the box is in the bottom of viewport
            end: "top 20%", //when the box is in the 20% of top of viewport
            scrub: true,
          },
          ease: "power1.inOut",
        });
